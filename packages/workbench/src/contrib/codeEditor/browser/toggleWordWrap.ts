...
import { addDisposableListener, onDidRegisterWindow } from '@sidex/base/browser/dom.js';
...
import { IActiveCodeEditor, ICodeEditor, IDiffEditor } from '@sidex/editor/browser/editorBrowser.js';
import {
	EditorAction,
...
import { findDiffEditorContainingCodeEditor } from '@sidex/editor/browser/widget/diffEditor/commands.js';
import { EditorOption } from '@sidex/editor/common/config/editorOptions.js';
import { IDiffEditorContribution, IEditorContribution } from '@sidex/editor/common/editorCommon.js';
...
const EDITOR_WORD_WRAP = new RawContextKey<boolean>(
	'editorWordWrap',
	false,
	nls.localize('editorWordWrap', 'Whether the editor is currently using word wrapping.')
);
