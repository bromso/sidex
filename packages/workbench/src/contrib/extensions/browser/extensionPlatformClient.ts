...
export type ExtensionStatus = 'discovered' | 'loading' | 'activated' | 'failed' | 'deactivated' | 'disabled';
...
export async function wasmProvideDocumentSymbolsAll(uri: string, languageId: string, version: number): Promise<any> {
