...
import { EditorCommand, ServicesAccessor, registerEditorCommand } from '@sidex/editor/browser/editorExtensions.js';
...
import { EditorOption, IEditorOptions } from '@sidex/editor/common/config/editorOptions.js';
...
import { CompletionContext, CompletionItemKind, CompletionList } from '@sidex/editor/common/languages.js';
...
import { CompletionOptions, provideSuggestionItems } from '@sidex/editor/contrib/suggest/browser/suggest.js';
...
import { defaultButtonStyles, defaultSelectBoxStyles } from '@sidex/platform/theme/browser/defaultStyles.js';
import { editorForeground } from '@sidex/platform/theme/common/colorRegistry.js';
